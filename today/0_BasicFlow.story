...
When register with {"email": "kishor+54expert@atlogys.com","password": "testing123" } as expert1

Then check success code 2001

When Resend email verification instructions for {"email": "kishor+54expert@atlogys.com"}
...
Given an user
When register with {"email": "kishor+54user@atlogys.com","password": "testing123" } as user1
Then Verify Email
