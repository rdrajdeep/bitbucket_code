...
public class GetStreamFeeds extends AbstractApiFactory implements HTTPCode, ExpertChatEndPoints {
    ...
    public void getFeeds(String id, By by){
         ...
         switch (by.ordinal()){
             ...
             case 0 : getFeedsByExpertProfileId(id); break;

             case 1 : getFeedsByExpertId(id); break;

             case 2 : getFeedsByTagId(id); break;

             default: throw new ExpertChatException("Exception has occurred");
         }
    }
}
