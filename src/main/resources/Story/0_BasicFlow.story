...
When register with {"email": "rajdeep+x4@atlogys.com","password": "rajdeep123" } as expert1

Then check success code 2001

When Resend email verification instructions for {"email": "rajdeep+x4@atlogys.com"}
...
Given an user
When register with {"email": "rajdeep+u3@atlogys.com","password": "testing123" } as user1
Then Verify Email
